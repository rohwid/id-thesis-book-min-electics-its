...
\setlength{\parindent}{1cm} Puji dan syukur kehadirat Allah SWT atas segala limpahan berkah, rahmat, serta hidayah-Nya, penulis  dapat menyelesaikan penelitian ini dengan judul \textbf{Perhitungan Kenaikan \textit{Stats} Level Pemain dan \textit{Non-Player Character} pada Permainan \textit{Role-Playing Game} berbasis K-NN dan Naive Bayes}.
\vspace{1ex}
